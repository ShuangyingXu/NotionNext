...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Shuangying Xu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '<div>Computational Design and Development<br/>/Robotic Fabrication</div>', // 作者简介
